...
3. Imported starter sites from the Spice Starter Sites plugin instead of the One Click Demo Import plugin.
@version 3.5.1
1. Fixed customizer issue.
@version 3.5
1. Updated the options page.
@version 3.4.9
1. Recommended the Spice Blocks plugin on the options page.
@version 3.4.8
1. Added separator in sidebar & footer widget area.
2. Updated google font family.
@version 3.4.7
1. Added rtl language support.
@version 3.4.6
1. Added Spice Post Slider support.
@version 3.4.5
1. Added Selective Refresh for customizer settings.
@version 3.4.4
