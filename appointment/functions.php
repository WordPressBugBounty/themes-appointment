...
function appointment_setup() {
    ...
    if ('Appointment' == $theme->name || 'Appointment Child' == $theme->name || 'Appointment child' == $theme->name || 'Appointment Green' == $theme->name || 'Appointment Red' == $theme->name || 'Appointment Blue' == $theme->name) {
        if (is_admin()) {
