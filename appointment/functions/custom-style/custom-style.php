	...
	?>
		<style type="text/css">
     	...
     	body .navbar-default .navbar-nav > .active > a,body .navbar .navbar-nav > .open.active > a { color:#ffffff; }
			...
			body .post .nav-title:hover,.post .nav-title:focus{color:<?php echo $link_color; ?>;}

			body .related-blog-post-sm a:hover,body .related-post-caption h4 a:hover,body .related-blog-post-author .blog-admin-lg a:hover{color:  <?php echo $link_color; ?>;}
			body .related-post-scroll-btn li a:hover {background-color: <?php echo $link_color; ?>;} 
			body .related-blog-post-sm i{color: <?php echo $link_color; ?>;}
			body .related-post-image{border-bottom: 2px solid <?php echo $link_color; ?>;}

			body .sidebar-widget h1:before,body .sidebar-widget h2:before,body .sidebar-widget h3:before,body .sidebar-widget h4:before,body .sidebar-widget h5:before,body .sidebar-widget h6:before,body .sidebar-widget .wp-block-search .wp-block-search__label:before,
			body .footer-widget-section h1:before,body .footer-widget-section h2:before,body .footer-widget-section h3:before,body .footer-widget-section h4:before,body .footer-widget-section h5:before,body .footer-widget-section h6:before,body .footer-widget-section .wp-block-search .wp-block-search__label:before,body h3.footer-widget-title:before{width: 60px;background: <?php echo $link_color; ?>; z-index:2;}
		</style>
		<?php
		$theme = wp_get_theme();
