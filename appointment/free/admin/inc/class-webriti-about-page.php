...
if (!class_exists('Appointment_About_Page')) {
	...
	public function style_and_scripts( $hook_suffix ) {
		...
		if ( 'appearance_page_appointment-welcome' == $hook_suffix || 'admin_page_spice-settings-importer' == $hook_suffix ) {

      		wp_enqueue_style('appointment-bootstrap-css',APPOINTMENT_TEMPLATE_DIR_URI.'/css/bootstrap.css');

			wp_enqueue_style( 'appointment-info-screen-css', get_template_directory_uri() . '/free/admin/assets/css/welcome.css' );

			wp_enqueue_style('appointment-theme-info-style', get_template_directory_uri() . '/free/admin/assets/css/welcome-page-styles.css');

			wp_enqueue_style('appointment_welcome_customizer', get_template_directory_uri() . '/free/admin/assets/css/welcome_customizer.css');
			wp_enqueue_script('plugin-install');
			wp_enqueue_script('updates');
			wp_enqueue_script('appointment-companion-install', get_template_directory_uri() . '/free/admin/assets/js/plugin-install.js', array('jquery'));
			wp_enqueue_script('appointment-about-tabs', get_template_directory_uri() . '/free/admin/assets/js/about-tabs.js', array('jquery'));
	  ...
	  <div class="container-fluid">
		...
		require_once( get_template_directory() . '/free/admin/tab-pages/getting-started.php' );
	}
	...
	public function github_file() {
		require_once( get_template_directory() . '/free/admin/tab-pages/useful_plugins.php' );
	}

	public function video_tab() {
		require_once( get_template_directory() . '/free/admin/tab-pages/video-detail.php' );
	}

	public function free_pro_demo() {
		require_once( get_template_directory() . '/free/admin/tab-pages/free-pro-demo.php' );
	}
	...
	public function welcome_free_pro() {
		require_once( get_template_directory() . '/free/admin/tab-pages/free_vs_pro.php' );
	}
	...
	public function recommending_actions() {
		require_once( get_template_directory() . '/free/admin/tab-pages/recommended_actions.php' );
	}
	...
	public function support_themes() {
		require_once( get_template_directory() . '/free/admin/tab-pages/support.php' );
	}
	...
	public function emailcourses_themes() {
		require_once( get_template_directory() . '/free/admin/tab-pages/emailcourse.php' );
	}
		...
		public function get_tabs_array() {
			...
			$tabs_array[]	= array(
					...
					'file_path' => get_template_directory() . '/free/admin/tab-pages/getting-started.php',
				);
			$tabs_array[]	= array(
					'link'      => 'free_pro_demo',
					'name'      => esc_html__('Starter Sites', 'appointment'),
					'file_path' => get_template_directory() . '/free/admin/tab-pages/free-pro-demo.php',
				);
			$tabs_array[]	= 	array(
					'link'      => 'recommended_actions',
					'name'      => esc_html__('Recommended Actions', 'appointment'),
					'file_path' => get_template_directory() . '/free/admin/tab-pages/recommended-actions.php',
				);

			$tabs_array[]	= 	array(
					'link'      => 'video_detail',
					'name'      => esc_html__('Video Tutorials', 'appointment'),
					'file_path' => get_template_directory() . '/free/admin/tab-pages/video-detail.php',
				);
			...
			if(count($this->get_useful_plugins()) > 0){
				$tabs_array[]	= 	array(
						...
						'file_path' => get_template_directory() . '/free/admin/tab-pages/useful_plugins.php',
				);
			}
			...
			$tabs_array[]	= 	array(
					...
					'file_path' => get_template_directory() . '/free/admin/tab-pages/free-vs-pro.php',
				);

			$tabs_array[]	= 	array(
					'link'      => 'support',
					'name'      => esc_html__('Support', 'appointment'),
					'file_path' => get_template_directory() . '/free/admin/tab-pages/support.php',
			);

     		$tabs_array[]	= 	array(
					'link'      => 'emailcourse_themes',
					'name'      => esc_html__('CREATE TRUSTWORTHY WEBSITES', 'appointment'),
					'file_path' => get_template_directory() . '/free/admin/tab-pages/emailcourse.php',
			);
		...
		public function get_plugin_icon( $icons ) {
			...
			if ( ! empty( $icons['svg'] ) ) {
				...
				$plugin_icon_url = get_template_directory_uri() . '/free/admin/assets/images/placeholder_plugin.png';
			}
