jQuery(document).ready(function($) {
    ...
    if(pluginInstallerAjax.hook_suffix ==='toplevel_page_appointment-welcome' || pluginInstallerAjax.hook_suffix ==='admin_page_spice-settings-importer' || pluginInstallerAjax.hook_suffix ==='appearance_page_appointment-welcome'){
        //console.log(pluginInstallerAjax.hook_suffix);
    ...
    $.ajax({
        ...
        method: 'POST',
        data: {
            action: 'appointment_check_plugin_status',
    ...
    $(button_id).on('click', function(e) {
        ...
        if ($button.text() === 'Install') {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: {
                    action: 'appointment_install_activate_plugin',
