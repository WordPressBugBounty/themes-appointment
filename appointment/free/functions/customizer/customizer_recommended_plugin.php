...
require get_template_directory() . '/free/functions/customizer-notify/appointment-customizer-notify.php';

function appointment_customizer_notify_setup() {
...
add_action( 'init', 'appointment_customizer_notify_setup' );