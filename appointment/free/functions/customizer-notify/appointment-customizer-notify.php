...
class appointment_Customizer_Notify extends \stdClass {
	...
	public function customizer_notify_scripts_for_customizer() {
		...
		wp_enqueue_style( 'appointment-customizer-notify-css', get_template_directory_uri() . '/free/functions/customizer-notify/css/appointment-customizer-notify.css', array());
		...
		wp_enqueue_script( 'appointment-customizer-notify-js', get_template_directory_uri() . '/free/functions/customizer-notify/js/appointment-customizer-notify.js', array( 'customize-controls' ));
		wp_localize_script(
	...
	public function plugin_notification_customize_register( $wp_customize ) {
		...
		require_once get_template_directory() . '/free/functions/customizer-notify/appointment-customizer-notify-section.php';
